...
{    
    ...
    gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, primitive == gl.LINES ? sphere_edges_buffer : sphere_faces_buffer);
    gl.drawElements(primitive, primitive == gl.LINES ? sphere_edges.length : sphere_faces.length , gl.UNSIGNED_SHORT, 0);
}